<script setup lang="ts">
    ...
    const props = withDefaults(defineProps<{
        ...
        tw_alignment?: string, // specify alignment of block content
        tw_gap?: string, // specify gap between child elements
        tw_width?: string, // specify width of block
        tw_height?: string, // specify height of block
        tw_z?: string, // specify z-index of block
        style_bindings?: {}
    }>(), {
    ...
    const rootClasses = computed(() => twMerge('flex py-2 gap-12 w-full items-center justify-center', props.tw_position, props.tw_direction, props.tw_padding, props.tw_background, props.tw_alignment, props.tw_gap, props.tw_width, props.tw_height, props.tw_z) );
</script>
