<script setup lang="ts">
    ...
    const rootClasses = computed(() => twMerge('flex gap-12 px-10 h-full justify-center', props.tw_position, props.tw_direction, props.tw_padding, props.tw_background, props.tw_alignment, props.tw_gap, props.tw_width, props.tw_height, props.tw_z) );
</script>
